...
const bundles = [
  { entrypoint: 'src/main.mjs', splitting: true }
]

const production = process.env.NODE_ENV === 'production'
const targetDir = production ? 'dist' : 'tmp'
...
const generateModuleBuild = lib => {
  const build = {
    ...
    format: 'esm',
    footer: { js: `// FicusJS App Shell ES Module bundle | v${process.env.npm_package_version}` },
    ...genericBuildOptions
  }
